...
data class Location(
     ...
     * @return the distance between the two locations, or POSITIVE_INFINITY if in different worlds
     */
    fun distanceTo(other: Location): Double {
        if (worldName != other.worldName) return Double.POSITIVE_INFINITY
        val dx = x - other.x
        val dy = y - other.y
        val dz = z - other.z
     ...
     *
     * @param other the other location
     * @return the squared distance, or POSITIVE_INFINITY if in different worlds
     */
     ...
     * @return true if within range, false if different worlds
     */
